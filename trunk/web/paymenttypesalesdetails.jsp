                                    ...
                                    <%
                                        ...
                                        if (labPayments != null) {
                                            for (int i = 0; i < labPayments.size(); i++) {
                                                ...
                                                labOrderId = paymentObjct.getTransactionId();
                                                ...
                                                try {
                                                    patient = mgr.getLabPatientByID(paymentObjct.getPatientId());
                                                ...
                                                if (hashMap.containsKey(labOrderId)) {
                                                    ...
                                                    System.out.println("Double.parseDouble(arr[1]) : " + Double.parseDouble(arr[1]) + " adding : " + outOfPocketPayment);
                                                    //       System.out.println("outOfPocketPayment : " + outOfPocketPayment);
                                                    double newValue = Double.parseDouble(arr[1]) + outOfPocketPayment;
                                                    System.out.println("newValue : " + newValue);
                                                    //          outOfPocketPayment += newValue;
                                                    //         System.out.println("makes out of pocket : " + outOfPocketPayment);
                                                    double newTotalSponsoredAmount = Double.parseDouble(arr[3]) + totalSponsoredAmount;
                                                    //      totalSponsoredAmount += Double.parseDouble(arr[3]) + totalSponsoredAmount;
                                                    hashMap.put(labOrderId, "" + count + "_" + newValue + "_" + patientName + "_" + newTotalSponsoredAmount);

                                                } else {
                                                    System.out.println("outOfPocketPayment : " + outOfPocketPayment);
                                                    hashMap.put(labOrderId, "1_" + outOfPocketPayment + "_" + patientName + "_" + totalSponsoredAmount);
                                                }
                                            }
                                        } else {
                                            response.sendRedirect("paymenttypesales.jsp");
...
%>
                                    ...
                                    <tr>
                                        ...
                                        <td><%=stringArray[2]%></td>
                                        <td style="text-align: right;"><%=stringArray[1]%>0</td>
                                        <td style="text-align: right;"><%=stringArray[3]%>0</td> 
                                    </tr>
                                    <%
                                            }
                                        }
