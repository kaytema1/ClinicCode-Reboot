        ...
        <%
            ...
            if (!sponsorId.isEmpty()) {
                ...
                if (sponsorToUse == null) {
                    response.sendRedirect("labsponsorshipreports.jsp");
                    return;
                }
            } else {
                response.sendRedirect("labsponsorshipreports.jsp");
            ...
            if (correctDateFound) {
                if (singleDateValue) {
                    allPayments = mgr.listLabPaymentsForDate(dateSqlDate);
                } else {
                    allPayments = mgr.listLabPaymentsForDuration(dateSqlDate, rangeSqlDate);
                }
            } else {
                allPayments = mgr.listLabPaymentsForDate(mgr.getCurrentDate());
            }
