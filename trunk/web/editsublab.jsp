...
<html>
    <head>
        ...
        <%
            ...
            Investigation mainInvestigation = null;
            try {
                mainInvestigation = mgr.getDetailedInvById(labtypes.getGroupedUnderId());
            } catch (Exception e) {
                response.sendRedirect("addlabtypes.jsp");
            }
            ...
            <header  class="jumbotron subhead" id="overview">
                ...
                <div style="margin-top: 20px; margin-bottom: -50px;" class="subnav navbar-fixed-top hide">
                    <ul class="nav nav-pills">
                        ...
                        <li class="active"> 
                            <a href="#">Edit Sub-Investigation</a><span class="divider"></span>
                        </li>
                        ...
                        <div style="padding-bottom: 80px; max-height: 800px;" class="span9 thumbnail  content">
                            ...
                            <ul style="margin-left: 0px; padding-bottom: 15px; " class="breadcrumb">
                                <li style="padding-top: 10px; font-size: 14px; font-weight: bold">
                                    <a href="#">Edit Sub Investigation | <%=labtypes.getName()%> | Falls Under <%=mainInvestigation.getName()%></a></li>
                            ...
                            <div id="tabs">
                                <ul>
                                    <li><a href="#tabs-1">Sub Investigation Information</a></li>
                                    <li><a href="#tabs-2">Reference Information</a></li>
                                    <li><a href="#tabs-3">Result Options</a></li>
                                </ul>
                                <div id="tabs-1">
                                    <form id="maininvestigation" enctype="multipart/data"action="action/editsublabsavingaction.jsp" method="POST" class="form-horizontal">
                                        <fieldset>
                                            <div style="float: left; width: 50%" class="pre_first_half">
                                                ...
                                                <!--div class="control-group">
                                                    <label class="control-label" for="input01">Rate ( To be commented out ? )</label>
                                                    <div class="controls">
                                                ...
                                                <div class="control-group">
                                                    <label class="control-label" for="input01">NHIS Rate ( To be commented out ? )</label>
                                                    <div class="controls">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="checkbox inline">
                                                        <%if(labtypes.isAntibiotic()){%>
                                                        <input style="margin-left: 4px;" type="checkbox" checked="checked" name="hasantibiotic" id="hasantibiotic" value="TRUE" />
                                                        <%}else{%>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="checkbox inline">
                                                        <%if(labtypes.isIsSubheading()){%>
                                                        <input style="margin-left: 4px;" type="checkbox" checked="checked" name="subheading" id="hasantibiotic" value="TRUE" />
                                                         <%}else{%>
                                        ...
                                        <div  class="form-actions">
                                            ...
                                            <input class="input-medium" count="1" id="option1" type="hidden" name="typeoftestid" value="<%=labtypes.getTypeOfTestId()%>">

                                            <input  type="hidden" name="grpunderid" value="<%=mainInvestigation.getDetailedInvId()%>"/>
                                            <button id="submitbutton" type="submit" name ="action" value="editsublab" class="btn btn-danger btn-small pull-right">
                                ...
                                <div id="tabs-2">
                                    ...
                                    <form id="maininvestigation" enctype="multipart/data"action="action/editsublabrefrencesavingaction.jsp" method="POST" class="form-horizontal">
                                            ...
                                            <div class="pull-left">
                                                ...
                                                <div id="detailed" class="control-group thumbnail hide">
                                                    ...
                                                    <table class="table-bordered">
                                                        ...
                                                        <input type="hidden" id="hiddencountDet" name="hiddencountDet" value="<%= counter%>" >
                                ...
                                <div id="tabs-3">
                                    ...
                                    <form style="width: 50%;" id="maininvestigation" enctype="multipart/data"action="action/editlabresultsavingaction.jsp" method="POST" class="form-horizontal">
                                        ...
                                        <div  class="form-actions">
                                            <input class="input-medium" count="1" id="option1" type="hidden" name="labid" value="<%=labtypes.getDetailedInvId()%>">
                                            <button id="submitbutton" type="submit" name ="action" value="editsublabresultoptions" class="btn btn-danger btn-small pull-right">
                                                <i class="icon-ok icon-white"></i> Save Changes
                                            </button>
