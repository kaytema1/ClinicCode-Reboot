                                                                                    ...
                                                                                    <div style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; " class="row center">
                                                                                        ...
                                                                                        <table style="width: 50%; float: left; margin-left: 6px; font-size:  10px; text-transform: uppercase;">
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td style="line-height: 20px; text-transform: uppercase; font-size: 11px;">
                                                                                                    <%=vst.getDonedate() == null ? "" : datetimeformat.format(vst.getDonedate())%>
                                                                                                </td>
                                                                                            </tr>
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 12px;" colspan="4">
                                                                                                    ...
                                                                                                    %>
                                                                                                    <div style="text-align: center;"><h3 style="font-weight:300; font-size: 13px; letter-spacing: 2px;  margin-top: 5px;text-align: center; width: 100%; text-transform: uppercase; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 12px;  ">
                                                                                                            <%=value%></h3> 
                                                                                                    </div>
                                                                                                    <table cellspacing="0">
                                                                                                        <thead>
                                    ...
                                    <tr class="hide">
                                        ...
                                        <td style="text-align: center;">
                                          ...
                                          <!--  <button class="btn btn-info btn-small" href="" onclick='printSelection(document.getElementById("print<%=vst.getOrderid()%>")); dispatch("clinic_<%=vst.getOrderid()%>");return false'>
                                            ...
                                            <%} else {%>
                                            <button class="btn btn-info btn-small" href="" onclick='printSelection(document.getElementById("print<%=vst.getOrderid()%>")); dispatch("print_<%=vst.getOrderid()%>");return false'>
                                                <i class="icon-white icon-print"></i> Print Result
                                            </button>
                                            <%}%>
                                            <%} else {%>
                                            <a id="settle<%=vst.getVisitid()%>" href="laboutstandingbills.jsp" class="btn btn-danger btn-small"> <i class="icon-white icon-print"></i>  Settle Outstanding | <%=df.format(vst.getOutstanding())%> </a> <br/> 
                                            <a  class ="btn btn-small btn-inverse" style="color: white;" href="#" id="confirm<%=vst.getVisitid()%>"> <i class="icon-white icon-lock"></i> Admin Override</a>
                                            <button id="adminprint<%=vst.getVisitid()%>" class="btn btn-info btn-small hide" href="" onclick='printSelection(document.getElementById("print<%=vst.getOrderid()%>")); return false'>
                                                <i class="icon-white icon-print"></i> Print Result
                                            </button>
                            ...
                            <div class="hide" id="popupdiv<%=vst.getOrderid()%>" title="Enter the Difference Owned">
                                <form class="form-horizontal" action="action/labaction.jsp" method="post">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input value="" class="input-mini" name="difference" type="text"/>
                                        </div>
...
<script type="text/javascript" charset="utf-8">
    $(document).ready(function() {
        ...
        $("#verify<%=vst.getVisitid()%>").click(function(){
            ...
            $.post('patientcount.jsp', {action : "patientauthorization", username : username, password : password}, function(data) {
                //alert(data);
                var bool = data;
                if(bool==0){
