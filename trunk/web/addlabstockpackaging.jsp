            ...
            <header  class="jumbotron subhead" id="overview">
                ...
                <div style="margin-top: 20px; margin-bottom: -50px;" class="subnav navbar-fixed-top hide">
                    <ul class="nav nav-pills">
                        ...
                        <li class="active">
                            <a href="#">Laboratory Stock Packaging</a><span class="divider"></span>
                        </li>
                    ...
                    <div style="margin-top: 0px; "class="span7 offset3 content1 hide">
                        ...
                        <div style="padding-bottom: 80px;" class="span7 thumbnail  content">
                            <ul style="margin-left: 0px;" class="breadcrumb">
                                <li>
                                    <h4>Add New Lab Stock Packaging</h4>

                                </li>

                            </ul>

                            <form class="form-horizontal" action="action/labstockpackagingaction.jsp" method="post" onsubmit="return validateForm();" name="items" >

                                <fieldset>

                                    <div class="control-group">
                                        <label class="control-label" for="input01"> Stock Package Name: </label>
                                        <div class="controls">
                                ...
                                <div class="form-actions">
                                    ...
                                    <button class="btn btn-small btn-info" type="submit" name="action" value="units" onclick='submitform();return false;'>
                                        <i class="icon-check icon-white"> </i> Add Package 
                                    </button>
