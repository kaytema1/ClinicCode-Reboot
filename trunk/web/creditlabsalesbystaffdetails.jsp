...
<html>
    <head>
        ...
        <%
            ...
            System.out.println("uniqs.size : " + uniqueLabOrderIds.size());
        %>
    </head>
                    ...
                    <div style="margin-top: 0px; "class="span12 offset3 content1 hide">
                        ...
                        <div style="padding-bottom: 80px;" class="span9 thumbnail well content">
                            ...
                            <table class="example display table">
                                ...
                                <tbody>
                                    <%
                                        if (!uniqueLabOrderIds.isEmpty()) {
                                            for (String particularOrderId : uniqueLabOrderIds) {

                                                double primarypmnt = 0, secpmnt = 0, totalSponsorAmnt = 0;
                                                String patientName = "",patientId = "", timePaid = "";
                                                LabPatient patient;
                                                for (PaymentObject payment : payments) {

                                                    if (payment.getTransactionId().equalsIgnoreCase(particularOrderId)) {
                                                        patientName = "";
                                                        patientId = "";
                                                        //   totalSponsorAmnt = 0;
                                                        try {
                                                        ...
                                                        if (payment.getPrimarySponsorAmount() != null && payment.getPrimarySponsorAmount() > 0) {
                                                            primarypmnt = payment.getPrimarySponsorAmount();
                                                            totalOutOfPocketAmount += payment.getPrimarySponsorAmount();
                                                            totalSponsorAmnt += payment.getPrimarySponsorAmount();
                                                        }
                                                        if (payment.getSecSponsorAmount() != null && payment.getSecSponsorAmount() > 0) {
                                                            secpmnt = payment.getSecSponsorAmount();
                                                            totalOutOfPocketAmount += payment.getSecSponsorAmount();
                                                            totalSponsorAmnt += payment.getSecSponsorAmount();
                                                        }
                                                ...
                                                if (totalSponsorAmnt > 0) {

                                    %>
                                    <tr>
                                        <td style="line-height: 25px; text-transform: uppercase; color: #4183C4;  font-weight: bolder; font-size: 18px;"><%=patientId%></td>
                                        <td style="line-height: 25px; text-transform: uppercase; color: #4183C4;  font-weight: bolder; font-size: 18px;"><%=particularOrderId%></td>
                                        ...
                                        <td style="text-align: right;"><%=df.format(totalSponsorAmnt)%></td>
                                    </tr> 
                                ...
                                <td>TOTAL</td>
                                <td></td>
                                <td style="font-size: larger; text-align: right;"><b><%=totalOutOfPocketAmount%></b></td>
                                </tfoot>
                            </table>
