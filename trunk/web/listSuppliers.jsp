                            ...
                            <table class="example display">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-info" id="<%=itt.getId()%>_edit" onClick="editRecord(<%=id%>);" >
                                                <i class="icon-white icon-check"></i> Update
                                            </button>
                                        </td>

                                        <td>
                                            <button class="btn btn-info" id="<%=itt.getId()%>_edit" onclick="show_confirm(),deleteRecord(<%=id%>); ">
...
<script type="text/javascript">
    ...
    $("#<%= itt.getId()%>_adddrug_dialog").dialog({
        autoOpen : false,
        width : 1000,
        modal :true
    ...
    $("#<%= itt.getId()%>_link").click(function(){
      
        $("#<%=itt.getId()%>_dialog").dialog('open');
    ...
    $("#<%= itt.getId()%>_adddrug_link").click(function(){
        alert("");
        $("#<%=itt.getId()%>_adddrug_dialog").dialog('open');
