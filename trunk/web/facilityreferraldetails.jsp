...
<html>
    <head>
        ...
        <%
            ...
            String doctorid = request.getParameter("facilityid") == null ? "" : request.getParameter("facilityid");
            //List dispatch = mgr.listLabordersByStatus("Dispatched");
            List listorders = mgr.listLabordersByFacilityid(doctorid);
            ...
            <header  class="jumbotron subhead" id="overview">
                ...
                <div style="margin-top: 20px; margin-bottom: -50px;" class="subnav navbar-fixed-top hide">
                    <ul class="nav nav-pills">
                        ...
                        <li class="active">
                            <a href="#">Facility Referrals from <%= laborder.getFacility()%> </a><span class="divider"></span>
                        </li>
                        ...
                        <div style="padding-bottom: 80px;" class="span9 thumbnail well content">
                            <form action="" method="post">
                                <ul style="margin-left: 0px; padding-bottom: 20px;" class="breadcrumb ">
                                    <li style="margin-top: 10px;">
                                        <a style="font-size: 15px;">Laboratory Facility Referral Details From <%= laborder.getFacility()%> </a>
                                    </li>
                            ...
                            <table class="example display table">
                                ...
                                <tbody>
                                    ...
                                    %>
                                    <tr>
                                        <td style="text-transform: uppercase; color: #4183C4;  font-weight: bolder; font-size: 18px;"><%=laborders.getOrderid()%></td>
                                    ...
                                    <tr>
                                        <td style="font-size: larger; text-align: left;"><b>TOTAL</b></td><td></td><td></td><td></td><td></td>
                                        <td style="font-size: larger; text-align: right;"><b><%=df.format(totalAmout)%></b></td>
                                        <td style="font-size: larger; text-align: right;"><b><%=df.format(totalPaid)%></b></td>
                                        <td style="font-size: larger; text-align: right;"><b><%=df.format(totalOutstanding)%></b></td>
                                    </tr>
                                </tbody>
                            </table>
