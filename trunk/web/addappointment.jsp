...
<html lang="en">
    ...
    <body data-spy="scroll" data-target=".subnav" data-offset="50">
        ...
        <div class="container-fluid">
            ...
            <header  class="jumbotron subhead" id="overview">
                ...
                <div style="margin-top: 20px; margin-bottom: -50px;" class="subnav navbar-fixed-top hide">
                    <ul class="nav nav-pills">
                        ...
                        <li class="active">
                            <a href="#">New Appointment</a><span class="divider"></span>
                        </li>
            ...
            <section class="container-fluid" style="margin-top: -50px;" id="dashboard">
                ...
                <div class="row-fluid">
                    ...
                    <div style="display: none;" class="box main-c span8" id="myModal">
                        ...
                        <div id="chart_div" style="height: 100%; margin-top: -5px; padding: 0px; z-index: 1000; overflow: hidden; display: block; margin: 0 auto; padding-top: 50px; padding-left: 20px; padding-right: 20px; padding-bottom: 50px;" class="box-body">
                            ...
                            <a href="#">
                                <div style="width: 35%; margin-left: 5%; float: left;" class="center  well large_button registration_dialog_link">
                                    <img style="margin-top: -4px;" width= " 36px;" src="images/46.png" />  New Patient
                                </div> </a>
                            <a href="#">
                                <div style="width: 35%; margin-right: 5%; float: right;" class="dialog_link2 center  well large_button">
                                    <img style="margin-top: -4px;" width= " 36px;" src="images/16.png" /> Existing Patient
                                </div> </a>
        ...
        <div style="max-height: 600px; display: none" id="registration_dialog" title="New Registration">
            ...
            <form id="registration" enctype="multipart/data"action="action/aptregistrationaction.jsp" method="POST" class="form-horizontal well">
                <fieldset>
        ...
        <div style="display: none;" id="dialog2" title="Patient Search">
            ...
            <form class="form-horizontal" id="search_dialog" action="apsearchresults.jsp" method="post">
                <fieldset>
