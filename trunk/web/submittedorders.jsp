...
<html>
    <head>
        ...
        <%
            ...
            Date date = new Date();
            List<PurchaseOrder> itmss = mgr.listObjects("from PurchaseOrder where status='Submitted'");
                                ...
                                <tr> 
                                    ...
                                    <td>
                                        ...
                                        <div class="dialog" id="<%=itt.getPurchaseOrderId()%>_postdialog" title="<img src='images/danpongclinic.png' width='120px;'  class='pull-left' style='margin-top: 0px; padding: 0px;'/> <span style='font-size: 18px; position: absolute; right: 3%; top: 29%;'> REQUEST APPROVAL  </span>">
                                            ...
                                            <form action="action/requisitionaction.jsp" method="post" name="form_<%=itt.getPurchaseOrderId()%>" id="form_<%=itt.getPurchaseOrderId()%>">
                                                <div class="thumbnail">
                                                    ...
                                                    <table class="table-striped table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <%=orderItems.getInventoryItems().getItemDescription() + " " + orderItems.getInventoryItems().getStrength() + " " + orderItems.getInventoryItems().getItemForm().getFormDescription()%>
                                                                </td>
                                    ...
                                    <td>
                                        <form action="goods_received.jsp" method="post">
