...
<% try {
        ...
        if ("releasestock".equals(request.getParameter("action"))) {
            ...
            String remainingStockQty = request.getParameter("remainingStockQty") == "" ? "" : request.getParameter("remainingStockQty");
            System.out.println("remainingStockQty : " + remainingStockQty);
            String receivedFromId = request.getParameter("receivedFromId") == "" ? "" : request.getParameter("receivedFromId");
            System.out.println("receivedFromId : " + receivedFromId);
            String dispatchedToId = request.getParameter("dispatchedToId") == "" ? "" : request.getParameter("dispatchedToId");
            System.out.println("dispatchedToId : " + dispatchedToId);
            String qtydispatched = request.getParameter("qtydispatched") == "" ? "" : request.getParameter("qtydispatched");
            System.out.println("qtydispatched : " + qtydispatched);
            ...
            try {
                ...
                quantity = 0; // Double.parseDouble(qty);
         ...
         //           Double.parseDouble(unitprice), Double.parseDouble(totalprice), current.getStaffid(), new java.sql.Timestamp(new java.util.Date().getTime()));
            ...
            if (!stockItems.isEmpty()) {
                ...
                if (sItem != null) {
                    ...
                    incomingQty = 0;// Double.parseDouble(qty);
