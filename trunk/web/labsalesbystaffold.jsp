                            ...
                            <table class="example display table">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: left;"> Cash At Hand</th>
                                        <th style="text-align: left;"> Credit Sales</th>
                                        <th style="text-align: left;"> Cash OutStanding</th>
                                        <th>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;"> 
                                            <a class="btn btn-info btn-small" href="labsalesbystaffdetails.jsp?staffid=<%=key%>&datevalue=<%=displayedDate  %>">View Details </a> 
                                        </td>
                                    </tr>
                                    <%}%>
