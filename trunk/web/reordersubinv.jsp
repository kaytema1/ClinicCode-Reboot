            ...
            <header  class="jumbotron subhead" id="overview">
                ...
                <div style="margin-top: 20px; margin-bottom: -50px;" class="subnav navbar-fixed-top hide">
                    <ul class="nav nav-pills">
                        ...
                        <li class="active">
                            <a href="#">Reorder Investigation</a><span class="divider"></span>
                        </li>
                    ...
                    <div style="margin-top: 0px; "class="span9 offset3 content1  hide">
                        <div style="padding-bottom: 80px; max-height: 800px;" class="span9 thumbnail  content">
                            ...
                            <form class="form-horizontal" action="subinvreordering.jsp" method="post">
                                ...
                                <div class="control-group" id="groupunder">
                                ...
                                <div class="form-actions">            
                                    <button class="btn btn-small btn-info" type="submit" name="action" value="subordering" >
                                        <i class="icon-check icon-white"> </i> Fetch Sub Investigations
                                    </button> 
                                </div>
                            </form>
                            ...
                            <div title="New  Investigation" id="new" class="hide">
                                <form enctype="multipart/data"action="action/sublabsavingaction.jsp" method="POST" class="form-horizontal">
                                    <fieldset>
                                        ...
                                        <div  style="float: left;" class="second">            
                                            ...
                                            <div class="control-group">
                                                <label class="control-label" for="inputSuccess">Add Antibiotics</label>
                                                <div class="controls">
                                                    <table style="padding-left: 50px; margin-top: -10px;" >
                                                        <tr><td>
                                                                <label class="switch-container pull-right">
                                                                    <input  type="checkbox" name="" value="" id="resultsoptions_antibiotics" style="width: 100px" class="switch-input checkValue hide">
                                                                        <div class="switch">
                                            ...
                                            <div id="add_antibiotics" style="padding-left: 100px; padding-bottom: -50px;"class="control-group hide">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <input name="option_antibiotics_1" type="text" />
                                                            <input class="pull-left" type="hidden" id="hiddencount_antibiotics" name="hiddencount_antibiotics" value="1" />

                                                        </td>
                                                        <td>
                                                            <input  id="resultoptionadd_antibiotics"  class="btn btn-info pull-right" type="button" value="Add" />
                                            ...
                                            <div id="clonehub_antibiotics" style="padding-left: 100px; padding-bottom: -50px;" class="control-group hide clonehub_antibiotics">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <input count="1" id="option_antibiotics_1" type="text" >
                                                        </td>  
                                                    </tr>
                                                </table>
                                            </div>
