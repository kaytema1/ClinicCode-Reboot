    ...
    <head>
        ...
        <%
            ...
            if (request.getParameter("daterange") != null) {
                ...
                // 8/18/2013 - 8/25/2013
                String todaysDate = mgr.getCurrentDate() + "";
                 splittedDate = todaysDate.split("-");
                 dateValue = splittedDate[1].trim() + "/" + splittedDate[2].trim() + "/" + splittedDate[0].trim();
                //2013-08-25
                
                displayedDate = dateValue; //.replace("-", "/");
            ...
            if (correctDateFound) {
                if (singleDateValue) {
                    payments = mgr.listLabPaymentsForDate(dateSqlDate);
                } else {
                    payments = mgr.listLabPaymentsForDuration(dateSqlDate, rangeSqlDate);
                }
            } else {
                 payments = mgr.listLabPaymentsForDate(mgr.getCurrentDate());
            }
            ...
            Set<String> staffIds = new HashSet<String>();
                if (payments != null) {
                    ...
                    for (PaymentObject payment : payments) {
                        staffIds.add(payment.getStaffId());
                    }
                }
            ...
            <header  class="jumbotron subhead" id="overview">
                ...
                <div style="margin-top: 20px; margin-bottom: -50px;" class="subnav navbar-fixed-top hide">
                    <ul class="nav nav-pills">
                        ...
                        <li class="active">
                            <a href="#">Sales Analysis By Staff</a><span class="divider"></span>
                        </li>
                    ...
                    <div style="margin-top: 0px; "class="span12 offset3 content1 hide">
                        ...
                        <div style="padding-bottom: 80px;" class="span9 thumbnail well content">
                            <form action="" method="post">
                                <ul style="margin-left: 0px; padding-bottom: 20px;" class="breadcrumb ">
                                    <li style="margin-top: 10px;">
                                        <a style="font-size: 15px;">Sales Analysis By Staff | <%=displayedDate%></a>
                                    </li>
                            ...
                            <table class="example display table">
                                <thead>
                                    <tr>
                                        <th id="table_title" value="SALES ANALYSIS" colspan="2">SALES ANALYSIS</th>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;"> 
                                            <a class="btn btn-info btn-small" href="insurancesummarydetails.jsp?staffid=<%=key%>&datevalue=<%=displayedDate %>">View Details </a> 
                                        </td>
                                    </tr>
                                    <%}%>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var title =  $("#table_title").attr("value");
        
        $("#ToolTables_DataTables_Table_0_0").click(function(){
           alert("Yo!")
            $(".thumbnail").removeClass("span9").removeClass("well").removeClass("content")
            $(".thumbnail").addClass("container");
        })
        $('.example').dataTable({
            "bJQueryUI" : true,
            "bPaginate" : false,
