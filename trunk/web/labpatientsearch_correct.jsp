...
<html lang="en">
    ...
    <body data-spy="scroll" data-target=".subnav" data-offset="50">
                        ...
                        <table  class="display example table">
                            ...
                            <tbody>
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                    <%=mgr.getPatientFolder(p.getPatientid()).getStatus()%><td>
        ...
        <div style="max-height: 600px; y-overflow: scroll; display: none;" id="new_dialog"  title="Laboratory Test Selection for  <%= p.getFname()%> <% if (p.getMidname() != null) {%> <%=p.getMidname()%> <% }%> <%= p.getLname()%>">
            <form id="select_labs"  class="form-inline"  action="action/labaction.jsp" method="post">
                <div class="well thumbnail">
                    ...
                    <div class="center" id="lab">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div style="float: left"  class="radioset"> 
                                                                        ...
                                                                        <input class="selected_result" style="margin-top: 10px; width: 200px; "  type="checkbox" name="labtest1" id="test<%= investigation.getDetailedInvId()%>" labid="<%=investigation.getDetailedInvId()%>" labtestname="<%=investigation.getName()%>" labtestpricevalue="<%=df.format(investigation.getRate())%>" labtestprice="GH&#162;<%=df.format(investigation.getRate())%>" value="<%=investigation.getRate()%>><<%= investigation.getDetailedInvId()%>"  
                                                                               /><label style="width: 270px; font-size: 14px; text-align: center; float: left; margin-right: 30px; margin-bottom: 20px;text-transform: capitalize; "  for="test<%= investigation.getDetailedInvId()%>"><%=investigation.getName().toLowerCase()%> <span class='pull-right brand'>GH&#162;<%=mgr.sponsorshipDetails(p.getPatientid()).getType().equalsIgnoreCase("NHIS") ? df.format(investigation.getNhisRate()) : df.format(investigation.getRate())%></span></label>
                        ...
                        <div class="clearfix"></div>
                        <div>
                            <table style="width: 490px; margin-left: 28%;"  class="table">
                                <thead>
                                    <tr>
                        ...
                        <div style="width: 465px; margin-left: 28%; text-align: center; max-height:  150px; overflow-y: scroll; padding: 10px 20px; border: 1px solid #CCC;">
                        ...
                        <table style="width: 465px; margin-left: 28%; text-align: center; ">
                            <tfoot>
                            <td>
                                <b style="padding-left: 25px;"> Total Bill </b>

                            </td>
                            <td style="text-align: right;" id="labtestpricetotal">
                        ...
                        <div style="width: 465px; margin-left: 30%; text-align: center;">
                            <table>
                                <thead>
                                    <tr>
                                        <th style="color: #FFF; text-align: left;">
                                            Referred By
                                        </th>
                                        <th style="color: #FFF; text-align: left;">
                                            Facility
...
%>
                    ...
                    <div style="display: none;" class="span9 offset3 thumbnail well content1 hide">
                        <table cellpadding="0" cellspacing="0" border="0" class="display example table">
                            ...
                            <tbody>
                                ...
                                %>
                                <tr class="odd gradeX">
                                    <td class="patient" rel="popover" data-original-title="<span style='text-align:center;'> <h3>Patient Information Summary </h3> <h5> <b> <%= pp.getFname()%>, <%= pp.getLname()%> <%= pp.getMidname()%> </b></h5> <h5><b> Date of Birth :</b> <%= formatter.format(pp.getDateofbirth())%></h5> <span>"
                                    ...
                                    <td style="text-align: left;"><b><%= pp.getFname()%>  <%= pp.getMidname()%> <%= pp.getLname()%> </b>
                                    </td>
        ...
        %>
        <div style="max-height: 600px; y-overflow: scroll; display: none;" class=" hide" id="<%= ppp.getPatientid()%>_dialog"  title="Laboratory Test Selection for  <%= mgr.getLabPatientByID(ppp.getPatientid()).getFname()%> <%if (mgr.getLabPatientByID(ppp.getPatientid()).getLname() != null) {%> <%= mgr.getLabPatientByID(ppp.getPatientid()).getMidname()%> <% }%> <%= mgr.getLabPatientByID(ppp.getPatientid()).getLname()%>  ">
            <div class="well thumbnail">
                <form id="select_labs"  class="form-inline"  action="action/labaction.jsp" method="post">
                    <div class="center" id="lab">
                        <table>
            ...
            $(function() {
                ...
                $(".selected_result").change(function(){
                    ...
                    if($(this).is(':checked')){ 
                        ...
                        $('#selected_tests tbody').append("<tr ><td style='text-transform: capitalize;'  class="+labid+ ">"+labtestname+"</td><td style='text-align: right;' class="+labid+ ">"+ labtestprice +" </td></tr>");
