                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;"> 
                                            <a class="btn btn-info btn-small" href="sponsorsummarydetails.jsp?sponsorid=<%=sponsor.getSponshorshipid()%>&staffid=<%=staffid %>&datevalue=<%=displayedDate %>">View Details </a> 
                                        </td>
                                    </tr>
