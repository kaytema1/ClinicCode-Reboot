            ...
            <header  class="jumbotron subhead" id="overview">
                ...
                <div style="margin-top: 20px; margin-bottom: -50px;" class="subnav navbar-fixed-top hide">
                    <ul class="nav nav-pills">
                        ...
                        <li class="active">
                            <a href="#">Lab Sales By Staff Report Details by <%=mgr.getStafftableByid(staffid).getLastname()%> <%=mgr.getStafftableByid(staffid).getOthername()%> Patients</a><span class="divider"></span>
                        </li>
                            ...
                            <form action="" method="post">
                                <ul style="margin-left: 0px; padding-bottom: 20px;" class="breadcrumb ">
                                    <li style="margin-top: 10px;">
                                        <a style="font-size: 15px;">Lab Sales By Staff Report Details by <%=mgr.getStafftableByid(staffid).getLastname()%> <%=mgr.getStafftableByid(staffid).getOthername()%> | <%=incomingDateValue%></a>
                                    </li>
                                </ul>
                            </form>
