            ...
            <header  class="jumbotron subhead" id="overview">
                ...
                <div style="margin-top: 20px; margin-bottom: -50px;" class="subnav navbar-fixed-top hide">
                    <ul class="nav nav-pills">
                        ...
                        <li class="active">
                            <a href="#">Sales Analysis for <%=staffToUse.getLastname() + " " + staffToUse.getOthername()%></a><span class="divider"></span>
                        </li>
                            ...
                            <form action="labsponsorshipreports.jsp" method="post">
                                <ul style="margin-left: 0px; padding-bottom: 20px;" class="breadcrumb ">
                                    <li style="margin-top: 10px;">
                                        <a style="font-size: 15px;">Sales Analysis for<%=staffToUse.getLastname() + " " + staffToUse.getOthername()%> | <%=displayedDate%> </a>
                                    </li>
                                </ul>
                            </form>
                            <table class="example display table">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: left;"> Outstanding Bills</th>
                                ...
                                <tbody>
                                    <%
                                        ...
                                        double totalAmountPaid = 0, totalLabPayment = 0, outstanding = 0, totalOutstanding = 0, totalAmout = 0, totalLabAmount = 0;
                                        Set<String> numberOfLabsSet = new HashSet<String>();
                                        for (Sponsorship sponsor : allSponsors) {
                                            if (!sponsor.getType().equalsIgnoreCase("CASH")) {
                                                totalLabPayment = 0;
                                                ...
                                                totalLabAmount += totalLabPayment;
                                                totalOutstanding += outstanding;
                                                totalAmout += totalAmountPaid;
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right;"><%= df.format(outstanding)%>  </td>
                                        <td style="text-align: right;"><%= df.format(totalAmountPaid)%>   </td>
                                        <td style="text-align: center;"> 
                                            <a class="btn btn-info btn-small" href="creditlabsalesbystaffdetails.jsp?sponsorid=<%=sponsor.getSponshorshipid()%>&staffid=<%=staffid%>&datevalue=<%=displayedDate%>">View Details </a> 
                                        </td>
                                    </tr>
