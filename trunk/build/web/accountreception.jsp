                        ...
                        <div style="padding-bottom: 80px;" class="span9 thumbnail well content">
                            ...
                            <a href="#">
                                <div class="span3  center  well large_button registration_dialog_link">
                                    <img style="margin-top: -4px;" width= " 36px;" src="images/46.png" />  General Accounting
                                </div> </a>
                            <a href="#">
                                <div class="dialog_link2 span3 offset1 center  well large_button">
                                    <img style="margin-top: -4px;" width= " 36px;" src="images/16.png" />  Claims Management
                                </div> </a>
                           ...
                           <!-- <a href="fromclinic.jsp">
                                <div class="span3 center well large_button">
                                    <%if (visits != null) {%>
                                    <img style="margin-top: -4px;" width= " 36px;" src="images/123.png" />  Manager Area
                                    <%} else {%> No Visits Today<%}%>
                                </div> </a>
                            <a href="readyfordispatch.jsp">
                                <div class="span3 offset1  center well large_button">
                                    <img style="margin-top: -4px;" width= " 36px;" src="images/12.png" />  from the Clinic
                                </div> </a>-->
