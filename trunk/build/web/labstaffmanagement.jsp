        ...
        <script type="text/javascript">
            ...
            function deleteUnit(userid){
                ...
                if (userid != 0 || userid != ""){ 
                    ...
                    if (con ==true)
                    {
                        $.post('action/labstaffaction.jsp', { action : "delete", id : id}, function(data) {
            ...
            function reactivateUnit(userid){
                ...
                if (userid != 0 || userid != ""){ 
                    ...
                    if (con ==true)
                    {
                        ...
                        $.post('action/labstaffaction.jsp', { action : "activate", id : id}, function(data) {
        ...
        <div class="container-fluid">
            ...
            <header  class="jumbotron subhead" id="overview">
                ...
                <div style="margin-top: 20px; margin-bottom: -50px;" class="subnav navbar-fixed-top hide">
                    <ul class="nav nav-pills">
                        ...
                        <li class="active">
                            <a href="#">Laboratory Staff Management</a><span class="divider"></span>
                        </li>
            ...
            <section style="margin-top: -30px;" id="dashboard">
                        ...
                        <div style="padding-bottom: 80px;" class="span9 thumbnail well content">
                            <ul style="margin-left: 0px; padding-bottom: 15px; " class="breadcrumb">
                                <li style="padding-top: 10px; font-size: 14px; font-weight: bold">
                                    <a>Laboratory Staff Management</a>
                                </li>
                               <li class="pull-right">
                                ...
                                <tbody>
                                    <%
                                        for (int i = 0; i < itmss.size(); i++) {
                                            ...
                                            if(stafftable.getRole() == 6 || stafftable.getRole() == 9 || stafftable.getRole() == 13  ){
                                    ...
                                    <tr>
                                        ...
                                        <td> <% if (stafftable.isActive()) { %>
                                            ...
                                            <div style="display: none;" id="<%=stafftable.getStaffid()%>_dialog" title="Editing <%=stafftable.getLastname()%>, <%=stafftable.getOthername()%>">
                                                <form class="form-horizontal" action="action/labstaffaction.jsp" method="post"  name="items" >
                                                        ...
                                                        <tbody>
                                                            <% List lists = mgr.listPermissions();
                                                                ...
                                                                for (int v = 0; v < lists.size(); v++) {
                                                                    ...
                                                                    if(permission.getDepartmentid() == 4){
                                                            %>
                                                            <tr>
                                                                <td>
                ...
                <div style="display: none;" id="registration_dialog" title="New Employee">
                    <form class="form-horizontal" action="action/labstaffaction.jsp" method="post" id="createStaff" name="items" >
