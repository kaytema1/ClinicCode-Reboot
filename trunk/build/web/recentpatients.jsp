        ...
        <header  class="jumbotron subhead" id="overview">
            ...
            <div style="margin-top: 20px; margin-bottom: -50px;" class="subnav navbar-fixed-top hide">
                <ul class="nav nav-pills">
                    ...
                    <li class="active">
                        <a href="#">Todays's Visits</a><span class="divider"></span>
                    </li>
                                ...
                                <td>
                                    ...
                                    <form style="padding: 0px; margin: 0px;" class="form-horizontal" id="search_dialog" action="action/registrationaction.jsp" method="post">
                                        ...
                                        <div class="input-append">
                                            ...
                                            <button class="btn" name="action" value="folderlocation" type="submit">Move Folder</button>
                                        </div>
                                    </form>
                                </td>
