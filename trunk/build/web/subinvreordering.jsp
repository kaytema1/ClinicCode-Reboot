            ...
            <header  class="jumbotron subhead" id="overview">
                ...
                <div style="margin-top: 20px; margin-bottom: -50px;" class="subnav navbar-fixed-top hide">
                    <ul class="nav nav-pills">
                        ...
                        <li class="active">
                            <a href="#">Sub Investigations</a><span class="divider"></span>
                        </li>
            ...
            <section style="margin-top: -30px;" id="dashboard">
                ...
                <div class="row">
                    ...
                    <%
                        ...
                        List listTypes = null;
                        Labtypes lType = null;
                        Investigation mainInv = null;

                        System.out.println("labType hh : " + labType);

                        if (labType == null) {
                            response.sendRedirect("reordersubinv.jsp");
                            return;
                        }
                        ...
                        if (!labType.isEmpty()) {
                            ...
                            int mainInvId = Integer.parseInt(groupUnder);
                            mainInv = mgr.getInvestigation(mainInvId);
                            listTypes = mgr.listSubInvUnderMainInv(mainInvId);
                            //  listMainInvsUnderLabType(labTypeId);
                        }
                        ...
                        <div style="padding-bottom: 80px; max-height: 800px;" class="span9 thumbnail  content">
                            ...
                            <ul style="margin-left: 0px; padding-bottom: 15px; " class="breadcrumb">
                                <li style="padding-top: 10px; font-size: 14px; font-weight: bold">
                                    <a href="#">Sub Investigations <i class="icon-chevron-right"> </i><i class="icon-chevron-right"> </i>   <%=lType.getLabType()%> <i class="icon-chevron-right"> </i> <span style="text-transform: capitalize;"><%=mainInv.getName()%> </span> </a></li> </ul>

                            <% if (foundListTypes) {%>
                            <form class="form-horizontal" action="action/labtypeaction.jsp" method="post">   
                                <ul class="sortable">
                                    ...
                                    %>
                                    <li id="<%=labTypeId%>" class="ui-state-default"><span class="ui-icon ui-icon-arrowthick-2-n-s"></span><%=lt.getName()%>
                                      <a style="color: white; margin-left: 20px;" class="btn btn-danger btn-mini pull-right" href="" onclick='deleteUnit("<%=labTypeId%>");return false'>  <i class="icon-white icon-remove"></i> Delete</a>
                                       <a style="color: white;" class="btn btn-mini btn-info pull-right" href="editsublab.jsp?id=<%=lt.getDetailedInvId()%>"><i class="icon-white icon-edit"></i>  Edit</a> 
                                    </li>
                                ...
                                <div class="form-actions">
                                    <button class="btn btn-small btn-danger pull-right" type="submit" name="action" value="subordering" >
                                        <i class="icon-check icon-white"> </i> Save Sub-Investigations Order For <%=lType.getLabType()%>
                                    </button>  
                                </div>
                            </form>
