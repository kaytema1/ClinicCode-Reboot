...
<html>
    ...
    <style type="text/css" media="all">
        ...
        .ui-tabs-vertical .ui-tabs-nav { float: left; width: 15%; }
    ...
    <div class="container-fluid">
       ...
       ================================================== -->
        ...
        <section class="container-fluid" style="margin-top: -50px;" id="dashboard"> 
            ...
            <div style="padding-left: 20px; display: none;"  class="row-fluid main">
                <%
                ...
                <form id="patientconsultation" class="form-inline" action="action/labnpharmactions.jsp" method="post" id="frm">
                    ...
                    <ul style="display: none; margin-top: -3%;" class="menu span3">
                        ...
                        <li> <a style="font-size: 12px !important;" class="vital_link<%=visit.getPatientid()%>"> <i class="icon icon-check"> </i> Nurses Enquiry Review </a></li>
                    ...
                    <div style="display: none;   padding-right: 5%; margin-top: -3%" class="main-c">

                        <% if (previous_visits.size() > 0) {%>
                        <div class="thumbnail center previous_visit<%=visit.getPatientid()%>" style="width: 100%; line-height: 18px; padding-left: 1%; padding-right: 1%; ">
                            <ul style="margin-left: 0px; text-transform: uppercase; margin-bottom: 0px;" class="breadcrumb">
                                <li>
                                    <a style="text-align: center;"> <b> Previous Visits Summary </b></a>
                                </li>
                                <li class="pull-right">
                                    <button type="button" style="margin-top: -6%" class=" btn btn-small vital_link<%=visit.getPatientid()%>">
                                        Vital Review <i class="icon-arrow-right"></i>
                                    </button>
                                </li>
                            </ul>

                            <div class="clearfix"></div>
                            <div style="width: 99%" id="verticaltabs">
                                <ul>
                                    ...
                                    %>
                                    <li><a href="#tabs-<%=x + 1%> "> VISIT NO.<%=x + 1%></a></li>
                                ...
                                <% for (int x = previous_visits.size() - 1; x >= 0; x--) {
                                        ...
                                        Visitationtable vis = (Visitationtable) previous_visits.get(x);
                                %>
                                <div  class="thumbnail" id="tabs-<%=x + 1%>"> 
                                    <lead style="color: #0063DC; font-weight: light; text-transform: uppercase;" class="control-label pull-right">
                                    ...
                                    <div style="height: 100%">
                                        ...
                                        <div class="clearfix"></div>
                                        <br />
                                        <div style="width: 45%; font-size: 10px;" class="pull-left center">
                                            <lead style="color: #000; font-weight: bold; font-size: 10px; text-transform: uppercase;" class="control-label" >
                                        ...
                                        <div style="width: 45%; font-size: 10px; margin-left: 7%" class="pull-left center">
                                            <lead style="color: #000; font-weight: bold; font-size: 10px; text-transform: uppercase;" class="control-label" >
                                                SYSTEMIC REVIEW
                                            </lead> 
                                            <div class="clearfix"></div>
                                        ...
                                        <div style="width: 45%; font-size: 10px; margin-left: 7%" class="pull-left center">
                                            ...
                                            <table class="table table-striped">
                                                <thead>
                                                    <tr>
                                                        <th style="color: #FFF; font-weight: bolder">
                                                            INVESTIGATION
                                                        </th>
                                                        <th style="color: #FFF; font-weight: bolder">
                                                            RESULT
                        ...
                        <% }%>
                        <div  class="thumbnail hide center vital<%=visit.getPatientid()%>" style="width: 100%;  line-height: 18px; padding-left: 10px; ">
                            <ul style="margin-left: 0px; text-transform: uppercase" class="breadcrumb">
                                ...
                                <li class="pull-left">
                                    <button type="button" style="margin-top: -6%" class=" btn btn-small previous_visit_link<%=visit.getPatientid()%>">
                                        <i class="icon-arrow-left"></i> Previous Visit History
                                    </button>
                                </li>

                                <li>
                                    <a style="text-align: center;"> <b> NURSES ENQUIRY REVIEW </b></a>
                                </li>

                                <li  class="pull-right">
                                    <button type="button" style="margin-top: -6%"  class="btn btn-small complaints_link<%=visit.getPatientid()%> ">
                                        Presenting Complaint <i class="icon-arrow-right"></i>
                                    </button>
                                </li>
                            ...
                            <%
                                ...
                                if (nurses_patient_conditions.size() > 0 || nurses_condition_notes.size() > 0) {
                            %>
                            <table class="table table-striped">
                                <tr>
                                    <th style="font-size: 14px; color: #FFF;">
                                        Presenting Complaints
                                    </th>
                                    <td>
                                        <% if (nurses_patient_conditions.size() > 0) {
                                                for (int x = 0; x < nurses_patient_conditions.size(); x++) {
                                                    NursesPatientConditions condition = (NursesPatientConditions) nurses_patient_conditions.get(x);
                                        %>
                                        <%= mgr.getProblemOption(condition.getConditionId())%> <br/>
                                        <% }%>
                                        <br />
                                        <br />
                                        <% }
                                        ...
                                        <span style="font-style: italic; font-stretch: expanded; margin-left: 10px;"> NB: <%= note.getConditionNote()%>  </span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <% if (nurses_patient_onsets.size() > 0) {
                                                for (int x = 0; x < nurses_patient_onsets.size(); x++) {
                                                    NursesPatientOnsets onset = (NursesPatientOnsets) nurses_patient_onsets.get(x);

                                        %>
                                        <%= mgr.getOnsetOption(onset.getOnsetId())%>       <br />
                                        <% }%>
                                        <br />
                                        <br />
                                        <% }%>
                                        ...
                                        <span style="font-style: italic; font-stretch: expanded; margin-left: 10px;"> NB: <%= note.getOnsetNote()%>   </span>
                                ...
                                <tr>
                                    <th style="font-size: 14px; color: #FFF;">
                                        Previously Taken Relief Treatment
                                    </th>
                                    <td>
                                        <% if (nurses_patient_reliefs.size() > 0) {
                                                for (int x = 0; x < nurses_patient_reliefs.size(); x++) {
                                                    NursesPatientReliefs relief = (NursesPatientReliefs) nurses_patient_reliefs.get(x);
                                        %>
                                        <%= mgr.getReliefOption(relief.getReliefId())%>       <br />
                                        <% }%>
                                        <br />
                                        <br />
                                        <% }%>
                                        ...
                                        <span style="font-style: italic; font-stretch: expanded; margin-left: 10px;"> NB: <%= note.getReliefNote()%> </span>
                            ...
                            <% Vitaltable vitaltable = mgr.getVitaltableByid(visit.getVisitid());
                                if (vitaltable == null) {%>
                        ...
                        <div class=" complaints<%=visit.getPatientid()%> hide pull-left thumbnail" style="width: 100%; line-height: 18px; padding-left: 10px; ">
                            <ul style="margin-left: 0px; text-transform: uppercase" class="breadcrumb center">
                                <li class="pull-left">
                                    ...
                                    <button type="button" style="margin-top: -6%" class=" btn btn-small vital_link<%=visit.getPatientid()%>">
                                        <i class="icon-arrow-left"></i> Vital Review
                                    </button>
                                </li>
                                <li>
                        ...
                        <div style="display: none;" class=" thumbnail center medical_examination<%=visit.getPatientid()%>">
                            ...
                            <textarea name="majorexaminationfindings" style="width: 90%; height: 200px;"></textarea>
                        ...
                        <div style="display: none;" class="thumbnail center laboratory<%=visit.getPatientid()%>">
                            ...
                            <div id="tabs">
                                <ul>
                                    ...
                                    <li><a href="#tabs-2">Other Investigations</a></li>
                                </ul>
                                <%
                            ...
                            <div id="tabs">
                                ...
                                <div id="tabs-1">
                                    ...
                                    <table class="consult table"> 
                                        ...
                                        <tbody style="max-height: 100px; overflow-y: auto;"> 
                                            <tr>
                                                <td> <%
                                                    ...
                                                    %>
                                        <option  value="<%=treatment.getItemCode()%>_<%=treatment.getItemDescription() + " " + treatment.getStrength() + " " + treatment.getItemForm().getFormDescription()%>_dispensary"><%=treatment.getItemDescription()%></option> 
                                        <% }
                                        ...
                                        %>
                                        <option  value="<%=treatment.getItemCode()%>_<%=treatment.getItemDescription() + " " + treatment.getStrength() + " " + treatment.getItemForm().getFormDescription()%>_pharmacy"><%=treatment.getItemDescription()%></option> 
                                        <% }

                                            }
                                        %></td>
                                        <td style="width: 15%"> 
                                            <select class="select" style="width: 100%"  name="dosage" id="dosage<%=visit.getVisitid()%>">
                                                ...
                                                %>
                                                <option value="<%=dosage.getDosageId()%>_<%=dosage.getDescription()%>"><%=dosage.getShortCode()%></option> 
                                                <% }
                                                    }
                                                %>
                                            </select>
