    ...
    <body data-spy="scroll" data-target=".subnav" data-offset="50">
                ...
                <div class="center" id="lab">
                    <form  action="action/labaction.jsp" method="post">
                        <table id="appendx_3<%=p.getPatientid()%>" class="table table-bordered">
                            ...
                            <input type="hidden" class="copayment<%=patientinvestigation.getInvestigationid()%> total<%=patientinvestigation.getInvestigationid()%>" value="<%=df.format(price)%>" id="1_copaymentsecondarycashdefault_input<%=patientinvestigation.getInvestigationid()%>backup" />
                            ...
                            <td> 
                                ...
                                <label  class="switch-container">
                                    ...
                                    <input type="checkbox" id="1_copaymentsecondarycashdefault_input<%=patientinvestigation.getInvestigationid()%>check"  name="copaymentsecondarycashdefault" value="" attribute="copaymentsecondarycashdefault_input<%=patientinvestigation.getInvestigationid()%>" checked="checked"   style="width: 100px" class="switch-input hide copaymentsecondarycashdefault">
                                    <div class="switch">
                                ...
                                <div style="display: block; text-align: center;">
                                    <input  class="input-mini decimal sika  copayment<%=patientinvestigation.getInvestigationid()%> first<%=patientinvestigation.getInvestigationid()%>"  style=" text-align: right; vertical-align: bottom; display :none; " type="text" placeholder="0.00" id="1_copaymentsecondarycashdefault_input<%=patientinvestigation.getInvestigationid()%>" name="<%=patientinvestigation.getInvestigationid()%>_primarysponsor_<%=mgr.getSponsor(mgr.sponsorshipDetails(p.getPatientid()).getSponsorid()).getSponshorshipid()%>" value="<%=df.format(price)%>"/>     
                                    <input type="text" value="<%=df.format(price)%>" id="1_copaymentsecondarycashdefault_input<%=patientinvestigation.getInvestigationid()%>source" />
                            ...
                            <td>
                                ...
                                <label style="text-align: center" class="switch-container">
                                    <input type="checkbox" id="2_copaymentsecondarycashdefault_input<%=patientinvestigation.getInvestigationid()%>check"  name="copaymentsecondarycashdefault" value="" attribute="copaymentsecondarycashdefault_input<%=patientinvestigation.getInvestigationid()%>"   style="width: 100px" class="switch-input hide copaymentsecondarycashdefault"/>
                                    <div class="switch">
                                        <span class="switch-label">Yes</span>
                                        <span class="switch-label">No</span>
                                        <span class="switch-handle"></span>
                            ...
                            <td>
                                ...
                                <label class="switch-container">
                                    <input type="checkbox" id="copaymentsecondarycashdefault_input<%=patientinvestigation.getInvestigationid()%>check" name="copaymentsecondarycashdefault" value="" attribute="copaymentsecondarycashdefault_input<%=patientinvestigation.getInvestigationid()%>"   style="width: 100px" class="switch-input hide copaymentsecondarycashdefault">
                                    <div class="switch">
                                        <span class="switch-label">Yes</span>
                                        <span class="switch-label">No</span>
                                        <span class="switch-handle"></span>
                                ...
                                <div style="text-align: center; ">
                                    <input  class="input-mini sika decimal copayment<%=patientinvestigation.getInvestigationid()%> third<%=patientinvestigation.getInvestigationid()%>" style="text-align: right; display: none;" name="<%=patientinvestigation.getInvestigationid()%>_outofpocket" type="text" id="copaymentsecondarycashdefault_input<%=patientinvestigation.getInvestigationid()%>" placeholder="0.00"  value=""/>
                                    <input type="text" value="<%=df.format(price)%>" id="copaymentsecondarycashdefault_input<%=patientinvestigation.getInvestigationid()%>source" />
        ...
        <script type="text/javascript" charset="utf-8">
            ...
            $(document).ready(function() {
                ...
                $(".copaymentsecondarycashdefault").change(function(){
                    ...
                    if($(this).is(':checked')){  
                        ...
                        $("#"+attrID).css("display","block").addClass("text-error");
                        $("#1_"+attrID).css("display","block").addClass("text-error");
                        $("#2_"+attrID).css("display","block").addClass("text-error");
                        $("#1_"+attrID).attr("value","");
                        $("#1_"+attrID).attr("placeholder","0.00");
                        ...
                        //alert($("#1_"+attrID+"backup").attr("value"))
                        $("#1_"+attrID).attr("value",$("#1_"+attrID+"backup").attr("value"));
            ...
            %>
                                ...
                                var input_1 = parseFloat($("#1_copaymentsecondarycashdefault_input<%=patientinvestigation1_2.getInvestigationid()%>").attr("value"));
                                var input_2 = parseFloat($("#2_copaymentsecondarycashdefault_input<%=patientinvestigation1_2.getInvestigationid()%>").attr("value"));
                                var input_3 = parseFloat($("#copaymentsecondarycashdefault_input<%=patientinvestigation1_2.getInvestigationid()%>").attr("value"));
            ...
            %>
                ...
                $(".copayment<%=patientinvestigation1.getInvestigationid()%>").live('keyup',function(){
                ...
                $("#1_copaymentsecondarycashdefault_input<%=patientinvestigation1.getInvestigationid()%>").live('keyup',function(){
                    
                    var input1_bool = false;
                    var input2_bool = false;
                    var input3_bool = false; 
                    
                    var input_1 = parseFloat($("#1_copaymentsecondarycashdefault_input<%=patientinvestigation1.getInvestigationid()%>").attr("value"));
                    var input_2 = parseFloat($("#2_copaymentsecondarycashdefault_input<%=patientinvestigation1.getInvestigationid()%>").attr("value"));
                    var input_3 = parseFloat($("#copaymentsecondarycashdefault_input<%=patientinvestigation1.getInvestigationid()%>").attr("value"));
                ...
                $("#2_copaymentsecondarycashdefault_input<%=patientinvestigation1.getInvestigationid()%>").live('keyup',function(){
                ...
                $("#copaymentsecondarycashdefault_input<%=patientinvestigation1.getInvestigationid()%>").live('keyup',function(){
