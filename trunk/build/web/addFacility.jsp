    ...
    <head>
        ...
        <script type="text/javascript">
            function submitform(){
                    ...
                    $.post('action/labaction.jsp', { action : "facility", name : name, beds : beds}, function(data) {
                        alert(data);
                        location.reload();
            ...
            function updateUnit(id,name,occ){
                ...
                $.post('action/labaction.jsp', { action : "facilityedit", uname : uname, uid : uid,occupied : occupied}, function(data) {
                    alert(data);
                     location.reload();
                    $('#results').html(data).hide().slideDown('slow');
                } );
            ...
            function deleteUnit(id){
                ...
                if (con ==true)
                {
                    $.post('action/labaction.jsp', { action : "deletefacility", id : id}, function(data) {
                        alert(data);
                        location.reload();
                        $('#results').html(data).hide().slideDown('slow');
                    } );
    ...
    <body data-spy="scroll" data-target=".subnav" data-offset="50">
        ...
        <div class="container-fluid">
            ...
            <header  class="jumbotron subhead" id="overview">
                ...
                <div style="margin-top: 20px; margin-bottom: -50px;" class="subnav navbar-fixed-top hide">
                    <ul class="nav nav-pills">
                        ...
                        <li class="active">
                            <a href="#">Referring Facilities </a><span class="divider"></span>
                        </li>
            ...
            <section style="margin-top: -30px;" id="dashboard">
                            ...
                            <ul style="margin-left: 0px; padding-bottom: 15px;" class="breadcrumb">
                                ...
                                <li class="pull-right">
                                    <a href="#" class="dialog_link btn">
                                        <i class="icon-plus-sign"></i> New Facility
                                    </a>
                                ...
                                <tbody>
                                    <%
                                        for (int i = 0; i < itmss.size(); i++) {
                                            Facility referringDoctors = (Facility) itmss.get(i);
                                    %>
                                    <tr>
                                        <td style="text-transform: capitalize; color: #4183C4; font-weight: bold;">
                                            <%=referringDoctors.getDoctorIncharge()%>
                                        </td>
                                        <td>
                                            <%=referringDoctors.getFacilityName()%>
                                        </td>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <div style="display: none;" id="<%=referringDoctors.getId()%>_dialog" title="Editing <%=referringDoctors.getFacilityName()%>">
                                                <form class="form-horizontal" action="action/unitaction.jsp" method="post" name="edit">
                                                    <div class="control-group">
                                                        <label class="control-label" for="input01"> Doctor's In Charge </label>
                                                        <div class="controls">
                                                            <input type="text" name="uname" id="nameunit_<%=referringDoctors.getId()%>" value="<%=referringDoctors.getDoctorIncharge()%>">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="occ" id="occ_<%=referringDoctors.getId()%>" value="<%=referringDoctors.getFacilityName()%>">
                ...
                <div style="display: none;" id="dialog" title="New Facility">
                    <form class="form-horizontal" action="action/wardaction.jsp" method="post" onsubmit="return validateForm();" name="items" >

                        <fieldset>

                            <div class="control-group">
                                <label class="control-label" for="input01"> Doctor In Charge </label>
                                <div class="controls">
                            ...
                            <div class="form-actions">
                                ...
                                <button class="btn btn-info"  onclick='submitform();return false;'>
                                    <i class="icon-plus-sign icon-white"> </i> Add Facility
                                </button>
...
<% for (int i = 0;
            i < itmss.size();
            i++) {
        Facility vst = (Facility) itmss.get(i);
%>
