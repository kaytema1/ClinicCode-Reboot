            ...
            <section style="margin-top: -50px;" class="container-fluid" id="dashboard"> 
                ...
                <div class="row-fluid">
                    ...
                    <div style="display: none;" class="thumbnail main-c span8">
                        <table cellpadding="0" cellspacing="0" border="0" class="display example table-striped">
                            <thead>
                                <tr>
                                    <th>Folder Number </th>
                                    <th>Full Name </th>
                            ...
                            <tbody>
                                <%
                                    ...
                                    List visits = mgr.listUnitVisitationsByPatientStatus("In Patient");
                                ...
                                <div id="tabs-3">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr> 
                                                <td>
                                                    <%= symptoms.getNote() == null ? "" : symptoms.getNote()%>
                                                </td>
                                            </tr>
                                            <%}
                                                }%>
                                                        ...
                                                        <%
                                                            ...
                                                            if (treatments != null) {
                                                                for (int v = 0; v < treatments.size(); v++) {
                                                                    Treatments treatment = (Treatments) treatments.get(v);
                                ...
                                <div id="tabs-1">
                                    ...
                                    <div class="controls">
                                        <table>
                                            ...
                                            <tbody>
                                                <%
                                                    List prescriptions = mgr.listPatientTreatmentsByVisitId(visitObject.getVisitid());
                                                                    ...
                                                                    <div class="control-group">
                                                                        ...
                                                                        <div class="controls">
                                                                            <select name="medicine" id="medicine<%=visitObject.getVisitid()%>">
                                                                                <%
                                                                                    List ll = mgr.listPatientTreatmentsByVisitId(visitObject.getVisitid());
