...
<html lang="en">
    ...
    <body data-spy="scroll" data-target=".subnav" data-offset="50">
                                ...
                                <div id="chart_div" style=" margin-top: -5px; padding: 0px; z-index: 1000; overflow: hidden; display: block; margin: 0 auto; padding-top: 20px; padding-left: 20px; padding-right: 20px; padding-bottom: 50px;" class="box-body">
                                    ...
                                    <table style="font-size: 14px;" class="table-striped span6 table-bordered pull-left">
                                        ...
                                        <tr>
                                            ...
                                            <td><b style="text-transform: capitalize"> <%= mgr.getDepartmentByid(staff.getUnit()).getDepartment()%></b></td>
                                        </tr>
        ...
        <div  id="mydialog" title="Update Details">
            ...
            <form id="updateprofile" class="form-horizontal" action="searchresults.jsp" method="post">
                <fieldset>
                    <div class="control-group">
                        <label class="control-label" for="fname">Username</label>
                        <div class="controls">
                            <input class="text_input"  type="text" name="username" value="<%= user.getUsername()%>"  />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="text_input" type="text" <%=staff.getEmail() %> name="email"  id="midname"/>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="text_input" type="text" value="<%= staff.getNextofkin() %>" name="emergencycontact"  id="midname"/>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="text_input" type="text"  name="emergencyperson"  id="midname"/>
