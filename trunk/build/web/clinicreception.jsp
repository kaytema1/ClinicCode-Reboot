            ...
            <header  class="jumbotron subhead" id="overview">
                ...
                <div style="margin-top: 20px; margin-bottom: -50px;" class="subnav navbar-fixed-top hide">
                    <ul class="nav nav-pills">
                        <li class="active">
                            <a href="#">Clinic Home</a><span class="divider"></span>
                        </li>
                                ...
                                <div id="chart_div" style="width: 100%; height: 100%; margin-top: -5px;  z-index: 1000; overflow-x: hidden; max-height: 100%; overflow-y: scroll; display: block; margin: 0 auto; padding-top: 50px; padding-left: 2%; padding-right: 10px; padding-bottom: 50px;" class="box-body">
                                    ...
                                    <a href="records.jsp">
                                        <div style="margin-right: 5px;" class="span4 center pull-left  well large_button">
                                            <img style="margin-top: -4px;" width= "36px;" height="36px;" src="images/icons/011.png" />  Records
                                        </div>
                                    </a><%}
                                        if (role == 7 || role == 1 || role == 4) {%>
                                    <a href="opd.jsp">
                                        <div style="margin-right: 5px;" class="span4 center pull-left  well large_button">
                                            <img style="margin-top: -4px;" width= "36px;" height="36px;" src="images/icons/002.png" />  Nurses Station
                                        </div>
                                    </a>
                                     <a href="readyprocedureslist.jsp">
                                        <div style="margin-right: 5px;" class="span4 center pull-left  well large_button">
                                            <img style="margin-top: -4px;" width= "36px;" height="36px;" src="images/icons/002.png" />  Procedures
                                        </div>
                                    </a>
                                    <a href="nursesinpatients.jsp">
                                        <div style="margin-right: 5px;" class="span4 center pull-left well large_button">
                                            <%if (visits != null) {%>
                                            <img style="margin-top: -4px;" width= "36px;" height="36px;" src="images/icons/004.png" />  Wards
                                            <%} else {%> No Visits Today<%}%>
                                        </div>
                                    </a>
                                    <%}
                                        if (role == 5 || role == 1 || role == 4) {%>
                                    <a href="prescriptionorders.jsp">
                                        <div  style="margin-right: 5px;" class="span4 pull-left center  well large_button">
                                            <img style="margin-top: -4px; "width= "36px;" height="36px;" src="images/icons/024.png" />  Dispensary
                                        </div>
                                    </a>
                                    <%}
                                        if (role == 3) {%>
                                    <a href="consultingroom.jsp">
                                        <div style="margin-right: 5px;" class="span4 pull-left center well large_button">
                                            <img style="margin-top: -4px;" width= "36px;" height="36px;" src="images/icons/023.png" />  Consulting
                                        </div>
                                    </a>
                                    <a href="inpatients.jsp">
                                        <div style="margin-right: 5px;" class="span4 center pull-left well large_button">
                                            <%if (visits != null) {%>
                                            <img style="margin-top: -4px;" width= "36px;" height="36px;" src="images/icons/004.png" />  Wards
                                            <%} else {%> No Visits Today<%}%>
                                    ...
                                    <a href="billing.jsp">
                                        <div style="margin-right: 5px;" class="span4 center pull-left  well large_button">
                                            <img style="margin-top: -4px;" width= "36px;" height="36px;" src="images/icons/001.png" />  Cashier
                                        </div>
                                    </a>
                                    <%}
                                        if (role == 1 || role == 4 || role == 10) {%>
                                    <a href="addnewitem.jsp">
                                        <div style="margin-right: 5px;" class="span4 center pull-left  well large_button">
                                            <img style="margin-top: -4px;" width= "36px;" height="36px;" src="images/icons/020.png" />  Stores / Inventory
                                        </div>
                                    </a>

                                    <a href="adminpanel.jsp">
                                        <div style="margin-right: 5px;" class="span4 center pull-left  well large_button">
                                            <img style="margin-top: -4px;" width= "36px;" height="36px;" src="images/icons/027.png" />  Administration
                                        </div>
                                    </a>
