    ...
    <body data-spy="scroll" data-target=".subnav" data-offset="50">
        ...
        <div class="container-fluid">
            ...
            <section style="margin-top: -30px;" id="dashboard">
                ...
                %>
                <%if (vst.getPatientid().contains("c") || vst.getPatientid().contains("C")) {%>
                <div style="display: none; max-height: 650px; overflow-y: scroll;" class="dialog" id="<%=vst.getOrderid()%>_dialog" title="LABORATORY RESULTS ENTRY FOR <%=mgr.getPatientByID(vst.getPatientid()).getFname()%> <%=mgr.getPatientByID(vst.getPatientid()).getLname()%> | <span style='text-transform: capitalize;'> <%=vst.getOrderid()%></span>">

                    <%} else {%>
                    <div style="display: none; max-height: 650px; overflow-y: scroll;" class="dialog" id="<%=vst.getOrderid()%>_dialog" title="LABORATORY RESULTS ENTRY FOR <%=mgr.getLabPatientByID(vst.getPatientid()).getFname()%> <%=mgr.getLabPatientByID(vst.getPatientid()).getLname()%> | <span style='text-transform: capitalize;'> <%=vst.getOrderid()%></span>">
                        ...
                        <% }%><div class="well thumbnail">
                            <form action="action/labaction.jsp" method="post">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <%
                                                    if (ptPatienttreatments.getPerformed().equalsIgnoreCase("Pending") ||  ptPatienttreatments.getResult().equals("") ) {
                                                ...
                                                <input type="text" name="results<%=ptPatienttreatments.getId()%>" />                 
                                                <%         }
                                                } else if (ptPatienttreatments.getPerformed().equalsIgnoreCase("Performed")) {%>
                                                <%=ptPatienttreatments.getResult()%>
                                                <% }%>
                                            ...
                                            <td style="text-align: center;">
                                                <% if (ptPatienttreatments.getPerformed().equalsIgnoreCase("Pending")) {%>
                                            ...
                                            <td style="text-align: center;">
                                                <% if (ptPatienttreatments.getPerformed().equalsIgnoreCase("Pending")) {%>
                                                <label style="margin-left: 25px;" class="switch-container">
                                                ...
                                                if (foundSubTests) {
                                                    ...
                                                    for (int j = 0; j < mainInvSubInvs.size(); j++) {
                                                        ...
                                                        if (!patInvsByInvIdNOrderId.isEmpty()) {
                                                            ...
                                                            Patientinvestigation ptPatienttreatmentsTemp = (Patientinvestigation) patInvsByInvIdNOrderId.get(0);
                                                            invName = inv.getName();
                                            %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <%if (ptPatienttreatments.getPerformed().equalsIgnoreCase("Pending") || ptPatienttreatmentsTemp.getResult().equals("") ) {
                                                ...
                                                <div class="controls">
                                                    <select class="MustSelectOpt" name="results<%=ptPatienttreatmentsTemp.getId()%>" >
                                                ...
                                                <%         } else {%>
                                                <input type="text" name="results<%=ptPatienttreatmentsTemp.getId()%>"/>                  
                                                <%           }
                                                %>

                                                <%} else {%>
                                                <input type="text" name="results<%=ptPatienttreatmentsTemp.getId()%>" id="isolate<%=ptPatienttreatmentsTemp.getId()%>"/>                 
                                                <%         }
                                                    }
                                                } else if (ptPatienttreatments.getPerformed().equalsIgnoreCase("Performed")) {%>

                                                <% if (!inv.isIsSubheading()) {%>
                                                <%=ptPatienttreatmentsTemp.getResult()%>
                                                <% }
                                                }%>
                                            </td>
                                            <%
                                            ...
                                            <td style="text-align: center;">
                                                ...
                                                <%if (inv.isAntibiotic()) {%>
                                                <button type="button" id="antibiotic<%=ptPatienttreatmentsTemp.getId()%>" class="btn btn-inverse addcomment btn-mini">
                                                    Show Antibiotics
                                                </button>
                                                <script type="text/javascript">
                                                    $("#antibiotic<%=ptPatienttreatmentsTemp.getId()%>").click(function(){
                                                        var id = <%=ptPatienttreatmentsTemp.getId()%>;
                                                        $("#ptid").attr("value",id);
                                            ...
                                            <td style="text-align: center;">
                                                <% if (ptPatienttreatments.getPerformed().equalsIgnoreCase("Pending")) {%>
                                                <button type="button" id="comment<%=ptPatienttreatmentsTemp.getId()%><%=vst.getOrderid()%>" class="btn btn-success addcomment btn-mini">
                                                    <i class="icon-white icon-plus"></i>Comment
                                                </button> <br/>
                                                <textarea class="comment<%=ptPatienttreatmentsTemp.getId()%><%=vst.getOrderid()%> hide" type="text" name="comment<%=ptPatienttreatmentsTemp.getId()%>"></textarea>
                                                <% }%>
                                            ...
                                            <td style="text-align: center; ">
                                                <% if (ptPatienttreatments.getPerformed().equalsIgnoreCase("Pending") || ptPatienttreatmentsTemp.getResult().equals("")) {%>
                                                <label  style="margin-left: 25px;" class="switch-container ">
                                                    <input  type="checkbox" name="afford[]" value="<%=ptPatienttreatmentsTemp.getId()%>"  style="width: 100px; display: none; " class="switch-input checkValue hide">
                                                    <div  class="switch">
                                                        <span class="switch-label">Yes</span>
                                                        <span class="switch-label">No</span>
                                                        <span class="switch-handle"></span>
                                ...
                                <div class="form-actions">
                                    <button class="btn btn-danger pull-right" type="submit" id="action" name="laboratory" value="OutstandingForward">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center; width: 100px; ">
                                            <label style="margin-left: 15px;" class="switch-container">
                                                <input type="checkbox" name="sensitive[]"  value="<%=antibiotic.getId()%>"class="switch-input  hide">
                                                <div class="switch">
                                                    <span class="switch-label">Yes</span>
                                                    <span class="switch-label">No</span>
                                                    <span class="switch-handle"></span>
                                        ...
                                        <td  style="text-align: center; width: 100px;">
                                            <label class="switch-container">
                                                <input type="checkbox"name="resistant[]" value="<%=antibiotic.getId()%>"class="switch-input  hide">
                                                <div class="switch">
                                                    <span class="switch-label">Yes</span>
                                                    <span class="switch-label">No</span>
                                                    <span class="switch-handle"></span>
