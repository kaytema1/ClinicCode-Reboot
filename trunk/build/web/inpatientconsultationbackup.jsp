...
<html>
            ...
            <section class="container-fluid" style="margin-top: -50px;" id="dashboard"> 
                ...
                <div style="padding-left: 20px; display: none;"  class="row-fluid main">
                    ...
                    <form id="patientconsultation" class="form-inline" action="action/labnpharmactions.jsp" method="post" id="frm">
                        ...
                        <ul style="margin-top: -3%;" class="menu span3">
                            <li> <a style="font-size: 12px !important;"class="previous_visit_link<%=visit.getPatientid()%> active"> <i class="icon  icon-file"> </i> Visit Summaries </a></li>
                        ...
                        <div style="display: none;   padding-right: 1%; margin-top: -3%" class="main-c span8">
                                ...
                                <div id="tabs">
                                    ...
                                    <div id="tabs-1">
                                        ...
                                        <table class="table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <%
                                                    List prescriptions = mgr.listPatientTreatmentsByVisitId(visit.getVisitid());
                                                    for (int p = 0; p < prescriptions.size(); p++) {
                                                        Patienttreatment patienttreatment = (Patienttreatment) prescriptions.get(p);
                                                        //String paString[] = patienttreatment.getDosage().getDescription();
                                            ...
                                            <tr>
                                                <td style="text-transform: capitalize; color: #4183C4; font-weight: bold; word-spacing: 5px;">
                                                    <a  id="dosage<%=patienttreatment.getId()%>link"> <%=print%></a>
                                                        ...
                                                        <form class="form-horizontal" action="" name="mainForm" id="mainForm">
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    ...
                                                                    <input type="hidden" name="visitid" id="visitid<%=patienttreatment.getId()%>" value="<%=visit.getVisitid()%>" />
                                                ...
                                                <td style="text-transform: capitalize; color: #4183C4; font-weight: bold; word-spacing: 5px;">
                                                    <%=patienttreatment.getDosage().getDescription()%>
                                                </td>
                                        ...
                                        <table class="table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align: left;">Patient Prescriptions</th>
                                                    <th style="text-align: left;">Quantity</th>
                                                    <th style="text-align: left;">Date Given</th>
                                                ...
                                                <%
                                                    List monitors = mgr.listDosagesMonitorByVisitid(visit.getVisitid());
                                        ...
                                        <div class="hide" id="dialog<%=visit.getVisitid()%>dosage">
                                            <form class="form-horizontal" action="" name="mainForm" id="mainForm">

                                                <div class="control-group">
                                                    <label class="control-label" for="inputPassword">Quantity</label>
                                                    <div class="controls">
                                                        <input type="text" name="quantity" id="quantity<%=visit.getVisitid()%>" value="" />
                                                        <input type="hidden" name="nurse" id="nurse<%=visit.getVisitid()%>" value="<%=user.getStaffid()%>" />
                                                        <input type="hidden" name="visitid" id="visitid<%=visit.getVisitid()%>" value="<%=visit.getVisitid()%>" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="medicine" id="medicine<%=visit.getVisitid()%>">
                                                            <%
                                                                List ll = mgr.listPatientTreatmentsByVisitId(visit.getVisitid());
                                                ...
                                                <div class="form-actions">
                                                    <div class="controls">
                                                        <button type="submit" class="btn btn-info btn-large" name="saveEvent" id="saveEvent" onclick='saveevent("nurse<%=visit.getVisitid()%>","visitid<%=visit.getVisitid()%>","quantity<%=visit.getVisitid()%>","medicine<%=visit.getVisitid()%>");return false;'>Save </button>
                                                    </div>
                                                </div>
                                            </form>
                                    ...
                                    <div id="tabs-2">
                                        ...
                                        <table class="consult table"> 
                                            ...
                                            <tbody style="max-height: 100px; overflow-y: auto;"> 
                                                <tr>
                                                    <td>  <select class="" style="width: 100%"  name="treatment" id="treatment<%=visit.getVisitid()%>">
                                                            <%
                                                        ...
                                                        %>
                                            <option  value="<%=treatment.getItemCode()%>_<%=treatment.getItemDescription() + " " + treatment.getStrength() + " " + treatment.getItemForm().getFormDescription()%>_dispensary" onclick='getDosagess("<%=treatment.getItemCode()%>")'><%=treatment.getItemDescription()%></option> 
                                            <% }
                                            ...
                                            %>
                                            <option  value="<%=treatment.getItemCode()%>_<%=treatment.getItemDescription() + " " + treatment.getStrength() + " " + treatment.getItemForm().getFormDescription()%>_pharmacy" onclick='getDosagess("<%=treatment.getItemCode()%>")'><%=treatment.getItemDescription()%></option> 
                                            <% }
                            ...
                            <div style="display: none;" class="thumbnail center completed<%=visit.getPatientid()%>"> 
                                ...
                                <div style="width: 20%; margin-left: 40%" >           
                                    <div class="pull-left center" style="width: 95%; padding-left: 15%">
                                        <label style="margin-top: 8px; font-size: 14px; width: 40%" class="pull-left">Discharge</label>
    ...
    <script type="text/javascript">
        ...
        <%  List vitalCheckList = mgr.listVitalCheckByVisitid(visit.getVisitid());
            if (vitalCheckList != null) {
                for (int z = 0; z < vitalCheckList.size(); z++) {
                    Vitalcheck vcheck = (Vitalcheck) vitalCheckList.get(z);
                    if (vcheck != null) {
        %>
...
%>
        ...
        chart = new Highcharts.Chart({
            chart: {
                renderTo: 'chart<%=visit.getPatientid()%>',
                type: 'line',
                marginRight: 130,
                marginBottom: 25
            },
        ...
        var chart1<%=visit.getPatientid()%>;
        chart1<%=visit.getPatientid()%> = new Highcharts.Chart({
                            
            chart: {
                renderTo: 'chart1<%=visit.getPatientid()%>',
                type: 'line',
                marginRight: 130,
                marginBottom: 25
            },
