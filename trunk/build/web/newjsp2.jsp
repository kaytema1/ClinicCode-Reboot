        ...
        <div class="container-fluid">
            ...
            <section class="container-fluid" style="margin-top: -30px;" id="dashboard">
                ...
                <div class="row-fluid">
                    ...
                    <div style="display: none; padding: 10px;" class="span9 thumbnail  main-c">
                        ...
                        <div style="text-align: center; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif" id="print<%=vst.getOrderid()%>" >
                            ...
                            <!--  <div class="btn-group">
                                  ...
                                  <ul class="dropdown-menu">
                                    ...
                                    <button class="btn btn-info btn-small pull-right" href="" onclick='hidePrint(); printSelection(document.getElementById("print<%=vst.getOrderid()%>"));
                                    return false'>
                            ...
                            <%}%>
                            <%} else {%>
                            <button id="popupdiv<%=vst.getOrderid()%>link" class="btn btn-info btn-small pull-right" href="" onclick=''>
...
%>
                                                        ...
                                                        %>
                                                        <tr id="patInv<%=patInv.getInvestigationid()%>"  style="line-height: 18px;">
                                                            <td  style="text-align: left; padding-left: 0px; font-weight: lighter;" colspan="5"> &#8226; &emsp; &emsp; (Comment)  <b> <%=comment%> </b>
