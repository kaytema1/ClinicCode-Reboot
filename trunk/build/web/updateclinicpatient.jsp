...
<%
    ...
    try {
        ...
        if (searchid.equalsIgnoreCase("fullname")) {
            ...
            list = mgr.getPatientByName(searchquery.trim());
        ...
        if (searchid.equalsIgnoreCase("patientid")) {
            ...
            patient = mgr.getPatientByID(searchquery.trim());
...
<html lang="en">
    ...
    <body style="overflow-y: scroll;" data-spy="scroll" data-target=".subnav" data-offset="50">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    <td style="text-transform: uppercase; color: #4183C4; font-weight: bolder; font-size: 18px;" class="patient" rel="popover" data-original-title="<span style='text-align:center;'> <h3>Patient Information Summary </h3> <h5> <b> <%= patient1.getFname()%>, <%= patient1.getLname()%> <%= patient1.getMidname()%> </b></h5> <h5><b> Date of Birth :</b> <%= formatter.format(patient1.getDateofbirth())%></h5> <span>"
                                        ...
                                        </table>"><b><a class="patientid"><% if (patient1.getEmergencyPatient() == 1) {%> 
                                                <%=patient1.getPatientid()%>EMG 
                                                <% } else {%>
                                    ...
                                    <td style="text-align: left;"> <%=formatter.format(mgr.getPatientByID(patient1.getPatientid()).getDateofregistration())%>
                                    </td>
        ...
        %>
        <div style="max-height: 90%; overflow-y: scroll; display: none;" class=" hide" id="<%= ppp.getPatientid()%>_dialog"  title="<img src='images/danpongclinic.png' width='120px;'  class='pull-left' style='margin-top: 0px; padding: 0px;'/> <span style='font-size: 18px; position: absolute; right: 5%; top: 29%; text-transform :uppercase;'> UPDATE <%= mgr.getPatientByID(ppp.getPatientid()).getFname()%> <%if (mgr.getPatientByID(ppp.getPatientid()).getLname() != null) {%> <%= mgr.getPatientByID(ppp.getPatientid()).getMidname()%> <% }%> <%= mgr.getPatientByID(ppp.getPatientid()).getLname()%> | <% if(patient.getEmergencyPatient()==1){ %> 
                                                <%=patient.getPatientid()%>EMG 
                                                <% } else { %>
                                                <%=patient.getPatientid()%>
                                                <%} %>'s DETAILS </span> ">
            <div class="well thumbnail">
                <form id="updateregistration<%=ppp.getPatientid()%>" action="action/updateregistrationaction.jsp" method="POST" enctype="multipart/data"  class="form-horizontal well" style="padding-top: 40px;">
                    <fieldset>
                        ...
                        <div class="first_half pull-left">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input readonly="readonly"  class="input-small" type="hidden" name="patientid"  id="input01" value="<%=ppp.getPatientid()%>"/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="day" id="day" class="input-mini"  value="<%=day.format(ppp.getDateofbirth())%>">
                                    <input name="month" id="month" class="input-mini"  value="<%=month.format(ppp.getDateofbirth())%>"/>
                                    <input name="year" id="year" class="input-mini"  value="<%=year.format(ppp.getDateofbirth())%>"/>
                        ...
                        <div class="pull-left"> 
                            ...
                            <div class="control-group">
                                <label class="control-label" for="inputSuccess">Other Phone No. *</label>
                                <div class="controls">
                                    <input type="text" name="second_contact" class="input-medium numeric" id="second_contact" value="<%=ppp.getSecondContact()%>"/>
                                    <span class="help-inline"></span>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea type="text" class="input-medium"   name="address" id="address"><%=ppp.getAddress()%></textarea>
                                    <span class="help-inline"></span>
                                </div>
                            </div>
                            <div class="control-group">
                        ...
                        <div style="float: left;" >
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" disabled="disabled"  class="input-medium" value="<%=mgr.sponsorshipDetails(ppp.getPatientid()) == null ? mgr.sponsorshipDetails(ppp.getPatientid()).getType() : mgr.sponsorshipDetails(ppp.getPatientid()).getType()%>" />   
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" disabled="disabled"  class="input-medium" value="<%=mgr.sponsorshipDetails(ppp.getPatientid()) == null ? mgr.getSponsor(mgr.sponsorshipDetails(ppp.getPatientid()).getSponsorid()).getSponsorname() : mgr.getSponsor(mgr.sponsorshipDetails(ppp.getPatientid()).getSponsorid()).getSponsorname()%>" />
                                </div>
                            </div>
                        ...
                        <div class="form-actions">
                            <button style="width: 80%; margin-left: 10%" type="submit" name ="action" value="patient" class="btn btn-info btn-largesubmit_button center">
                                <i class="icon-ok icon-white"></i> Update Patient Details
                            </button>
