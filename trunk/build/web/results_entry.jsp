                    ...
                    <div style="margin-top: 0px; "class="span12 offset3 content1 hide">
                        ...
                        <div style="padding-bottom: 80px;" class="span9 thumbnail well content">
                            ...
                            <table class="example display table">
                                ...
                                <tbody>
                                    <% 
                                                Laborders vst = (Laborders) labOrder;
                                                if (vst != null) {
                                    %>
                                    <tr>
...
<!--   <td><%=mgr.sponsorshipDetails(vst.getPatientid()) == null ? "" : mgr.sponsorshipDetails(vst.getPatientid()).getMembershipid()%>   </td>  -->
                ...
                %>
                <%if (vst.getPatientid().contains("c") || vst.getPatientid().contains("C")) {%>
                <div style="display: none; max-height: 90%; overflow-y: scroll;" class="dialog" id="<%=vst.getOrderid()%>_dialog" title="LABORATORY RESULTS ENTRY FOR <%=mgr.getPatientByID(vst.getPatientid()).getFname()%>
                    ...
                    <%} else {%>
                    <div style="display: none; max-height: 90%; overflow-y: scroll;" class="dialog" id="<%=vst.getOrderid()%>_dialog" title="LABORATORY RESULTS ENTRY FOR <%=mgr.getLabPatientByID(vst.getPatientid()).getFname()%> 
                        ...
                        <% }%><div class="well thumbnail">
                            <form action="action/labaction.jsp" id="results_entry<%=vst.getOrderid()%>" method="post">
                                <table class="table">
                                    <thead>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label class="switch-container">
                                                    <input  type="checkbox" name="afford[]" value="<%=ptPatienttreatments.getId()%>" confirm_id="confirm<%=vst.getOrderid()%>"  style="width: 100px" class="switch-input checkValue hide confirm lab_confirmation<%= vst.getOrderid()%>"/>
                                                    <div class="switch">
                                            ...
                                            <td>
                                                <label class="switch-container">
                                                    <input  type="checkbox" name="afford[]" value="<%=ptPatienttreatments.getId()%>"  style="width: 100px" class="switch-input checkValue hide lab_confirmation<%= vst.getOrderid()%>">
                                                            <div class="switch">
                                                        <span class="switch-label">Yes</span>
                                                        <span class="switch-label">No</span>
                                                        <span class="switch-handle"></span>
                                ...
                                <div class="form-actions">
                                    <button class="btn btn-danger pull-right submit<%=vst.getOrderid()%>" disabled="disabled"  type="submit" id="action" name="laboratory" value="Forward">
                    ...
                    <%}
                          %> 
                    <div style="max-height: 400px; overflow-y: scroll;" class="dialog hide" id="antibiotic_div" title="Antimicrobial Susceptibility Testing">
                        <div class="lead">
        ...
        <script type="text/javascript">
            $(document).mouseover(function(){
                    ...
                    var atLeastOneIsChecked = $('input.lab_confirmation<%= vst.getOrderid()%>:checkbox').is(':checked');
                    // Do something with atLeastOneIsChecked
                    
                    if(atLeastOneIsChecked){
                        $(".submit<%=vst.getOrderid()%>").removeAttr("disabled");
                    }else{
                        $(".submit<%=vst.getOrderid()%>").attr("disabled","disabled");
                    }
