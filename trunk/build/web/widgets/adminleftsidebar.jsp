...
<div style="height: 100%; position: fixed;" class="span3">
    <ul style="display: none;"  class="menu hide">
        ...
        if(role==7 || role==1 || role==4){%>
         <li class="item1">
            <a  href="#"><i class="icon-folder-open"></i> Nurses Desk</a>
            <ul>
                <li class="subitem2">
                    <a href="opd.jsp">Vitals </a>
                </li>
                  <li class="subitem2">
        ...
        <%}  if(role==7 || role==3 || role==1 || role==4){%>
        <li class="item2">
        ...
        <li class="item4">
            ...
            <ul>
                <li class="subitem1">
                    <a href="pharmacy.jsp">Treatment Orders <span><%=pharmacy.size()%></span></a>
                </li>
                 <li class="subitem1">
                    <a href="readytodispensed.jsp">Ready for Dispensing <span><%=pharmacy.size()%></span></a>
                </li>
                <li class="subitem1">
        ...
        <li class="item4">
            ...
            <ul>
                <li class="subitem1">
                    <a href="accounts.jsp">Registration & Consulting Bills <span><%=accs.size()%></span></a>
                </li>
                <li class="subitem1">
                    <a href="dispensary.jsp">Medicine Request Bills<span><%=pharmacy.size()%></span></a>
                </li>
                <li class="subitem1">
