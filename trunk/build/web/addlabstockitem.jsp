            ...
            <header  class="jumbotron subhead" id="overview">
                ...
                <div style="margin-top: 20px; margin-bottom: -50px;" class="subnav navbar-fixed-top hide">
                    <ul class="nav nav-pills">
                        ...
                        <li class="active">
                            <a href="#">Laboratory Stock Item</a><span class="divider"></span>
                        </li>
                    ...
                    <div style="margin-top: 0px; "class="span7 offset3 content1 hide">
                        ...
                        <div style="padding-bottom: 80px;" class="span7 thumbnail  content">
                            <ul style="margin-left: 0px;" class="breadcrumb">
                                <li>
                                    <h4>Add Lab Stock Item</h4>
                                </li>

                            </ul>

                            <form class="form-horizontal" action="action/labstockitemction.jsp" method="post" onsubmit="return validateForm();" name="items" >
