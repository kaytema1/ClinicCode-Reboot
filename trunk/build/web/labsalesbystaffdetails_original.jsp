                            ...
                            <table class="example display table">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: l;">    Total Bill</th>
                                ...
                                <tbody>
                                    <% double totalAmout = 0.0;
                                        ...
                                        if (listorders
                                            ...
                                            for (int i = 0; i < listorders.size(); i++) {
                                                ...
                                                if (laborders.getReceivedBy().equalsIgnoreCase(staffid)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><%= mgr.sponsorshipDetails(laborders.getPatientid()) == null ? mgr.getSponsor(mgr.sponsorshipDetails(mgr.getLabPatientByID(laborders.getPatientid()).getFolderNumber()).getSponsorid()).getSponsorname() : mgr.getSponsor(mgr.sponsorshipDetails(laborders.getPatientid()).getSponsorid()).getSponsorname()%></td>
                                        <td><%=laborders.getOrderdate() == null ? " " : formatter.format(laborders.getOrderdate())%></td> 
                                        <td>
                                            <%
                                     //      System.out.println("laborders.getFacility() : " + laborders.getFacility());
                                     //      System.out.println("laborders.getFromdoc() : " + laborders.getFromdoc());
                                           if (laborders.getFacility().equalsIgnoreCase("Danpong Clinic")) {
                                               String staffDocLastName = "";
                                               Stafftable staffDoc = mgr.getStafftableByid(laborders.getFromdoc());
                                               if(staffDoc != null ) {
                                                   staffDocLastName = staffDoc.getLastname();
                                               }
   %>
                                            <%=staffDocLastName %>
                                            <% } else {%>
                                            <%= laborders.getFromdoc()%>
                                            <% }%>
                                        </td>
                                ...
                                <tfoot>
                                    <tr>
                                        <td style="line-height: 25px; font-size: larger"><b>TOTAL</b></td><td></td><td></td><td></td><td></td>
                                        <td style="text-align: right; font-size: larger"><b><%=df.format(totalAmout)%></b></td>
                                        <td style="text-align: right; font-size: larger"><b><%=df.format(totalPaid)%></b></td>
                                        <td style="text-align: right; font-size: larger"><b><%=df.format(totalOutstanding)%></b></td>
                                    </tr>
                                </tfoot>
                            </table>
