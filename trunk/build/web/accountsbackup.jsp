                                        ...
                                        <div class="center thumbnail">
                                            ...
                                            <form action="action/accountsaction.jsp" method="post">
                                                ...
                                                <div style="text-align: center;" class="form-actions">
                                                    <button class="btn span3 btn-info pull-left" type="button" onclick='printSelection(document.getElementById("print<%=vst.getVisitid()%>")); return false'>
                                                    ...
                                                    <button style="float: right" type="submit" name="action"  value="Consultation Receipt" class="btn btn-danger span3 pull-right">
                                                    ...
                                                    <div style="text-align: center;">
                                                        ...
                                                        <a class ="btn  btn-inverse" style="color: white;" href="#" onclick='showdiscount("discount<%=vst.getVisitid()%>");return false' id="discount<%=vst.getVisitid()%>">
