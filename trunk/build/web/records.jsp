...
<html lang="en">
    ...
    <body data-spy="scroll" data-target=".subnav" data-offset="50">
                    ...
                    <div id="chart_div" style="height: 100%; margin-top: -5px; padding: 0px; z-index: 1000; overflow: hidden; display: block; margin: 0 auto; padding-top: 50px; padding-left: 20px; padding-right: 20px; padding-bottom: 50px;" class="box-body">
                        ...
                        <a href="#">
                            <div style="width: 40%; float:  left;" class="center  well large_button registration_dialog_link">
                                <img style="margin-top: -4px; margin-right: 15px;" width="36px;"height="36px;" src="images/icons/041.png" /> New Registration
                            </div> </a>
                        <a href="#">
                            <div style="width: 40%; float:  right;" class="dialog_link2 center  well large_button">
                                <img style="margin-top: -4px; margin-right: 15px;" width="36px;"height="36px;"  src="images/icons/042.png" /> Find Patient
                            </div> 
                        </a>
                        ...
                        <div class="clearfix"></div>
                        <a class="emergency_dialog_link" href="#">
                            <div style="width: 40%; float:  left;" class="center  well large_button">
                                <img style="margin-top: -4px; margin-right: 15px;" width="36px;"height="36px;" src="images/icons/041.png" /> Emergency Registration
                            </div> 
                        </a>
                        <a href="recentpatients.jsp">
                            <div style="width: 40%; float:  right;"  class="center well large_button">
                                ...
                                <%
                                    ...
                                    if (visits.size() > 0) {%>
                                Visits Today<span style="margin-left: 10px;" class="badge_b"><%=visits.size()%> </span>
                                <%} else {%> Visits Today  <span style="margin-left: 10px;" class="badge_b">0 </span> <%}%>
                            </div> 
                        </a>
        ...
        <div style="max-height: 600px; display: none" id="registration_dialog" title=" <img src='images/danpongclinic.png' width='120px;'  class='pull-left' style='margin-top: 0px; padding: 0px;'/> <span style='font-size: 18px; position: absolute; right: 5%; top: 29%;'> PATIENT REGISTRATION <span>">

            <form id="registration" enctype="multipart/data"action="action/registrationaction.jsp" method="POST" class="form-horizontal">

                <fieldset style="padding-top: 3%" class="thumbnail">
                        ...
                        <div class="control-group success hide">
                            ...
                            <div class="controls">
                                <% String yr = "" + Calendar.getInstance().get(Calendar.YEAR);
                                    ...
                                    String code = mg.getProfile("1").getClinicFolderCode();
                                ...
                                %>
                                <input type="text" name="patientid" readonly="readonly" id="input01" value="<%=(y + code + (number + 1))%>"/>
                    ...
                    <div style="float: left;" class="second">            
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="second_contact" class="input-medium" id="second_contact"/>
                                <span class="help-inline"></span>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea type="text" class="input-medium" name="address" id="address"></textarea>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="input-medium" type="text" name="email" id="email"/>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="input-medium" type="text" name="emergencyperson" id="emergencyperson"/>

                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Emergency Contact's Tel. No. *</label>
                            <div class="controls">
                ...
                <div class="save_registration center" style="margin-top: 5%; width: 100%; padding: 0px; margin-left: 0px;">
                    <button style="margin-left: 10%; width: 80%" type="submit" name ="action" value="patient" disabled="disabled" class="btn btn-info btn-large  submit_button">
        ...
        <div style="max-height: 600px; display: none" id="emergency_dialog" title=" <img src='images/danpongclinic.png' width='120px;'  class='pull-left' style='margin-top: 0px; padding: 0px;'/> <span style='font-size: 18px; position: absolute; right: 5%; top: 29%;'> EMERGENCY PATIENT REGISTRATION <span>">

            <form id="reregistration" enctype="multipart/data"action="action/registrationaction.jsp" method="POST" class="form-horizontal">

                <fieldset style="padding-top: 3%" class="thumbnail">
                    <div style="float: left; width: 100%" class="pre_first_half">
                        <div class="control-group gender_group">
                            <label class="control-label MustSel" for="input01">Gender *</label>
                            <div class="controls">
                                <select class="MustSelectOpt input-small required" name="gender" id="gender">
                ...
                <div style="width: 100%; margin-top: 5%" class="save_registration">
                    <div class="clearfix">

                    </div>
                    <button style="width: 80%; margin-left: 10%" type="submit" name ="action" value="emergencypatient" class="btn btn-info btn-large resubmit_button">
                        <i class="icon-ok icon-white"></i> Save Emergency Patient Registration
                    </button>
                </div>
        ...
        <div style="display: none;" id="dialog2" title=" <img src='images/danpongclinic.png' width='120px;'  class='pull-left' style='margin-top: 0px; padding: 0px;'/> <span style='font-size: 18px; position: absolute; right: 5%; top: 29%;'> PATIENT SEARCH <span>">

            <form class="form-horizontal" id="search_dialog" action="searchresults.jsp" method="post">
                <fieldset>
