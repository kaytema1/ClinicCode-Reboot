...
<% try {
    ...
    System.out.println("+++++++++++++++++++++++++");
        ...
        if ("units".equals(request.getParameter("action"))) {
            ...
            LabStockDistributor unit = null;
            unit = mgr.addLabStockDistributor(unitName, conP, num, loc);
            out.print("Lab Stock Distributor Successfully Added");
            response.sendRedirect("../addlabstockdistributor.jsp");
            return;
        }
