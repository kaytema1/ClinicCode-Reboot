...
/**
 * PatientReliefs generated by hbm2java
 */
@Entity
@Table(name="patient_reliefs"
    ,catalog="extended"
)
public class PatientReliefs  implements java.io.Serializable {
    ...
    public PatientReliefs() {
    }

    public PatientReliefs(int reliefId, String patientid, int visitid) {
