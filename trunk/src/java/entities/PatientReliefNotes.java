...
/**
 * PatientReliefNotes generated by hbm2java
 */
@Entity
@Table(name="patient_relief_notes"
    ,catalog="extended"
)
public class PatientReliefNotes  implements java.io.Serializable {
    ...
    public PatientReliefNotes() {
    }

    public PatientReliefNotes(String reliefNote, String patientid, int visitid) {
